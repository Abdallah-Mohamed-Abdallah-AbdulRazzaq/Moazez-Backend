output "migration_job_name" {
  description = "Name of the production governed Migration Job."
  value       = module.migration_job_environment.migration_job_name
}

output "migration_job_location" {
  description = "Region of the production governed Migration Job."
  value       = module.migration_job_environment.migration_job_location
}

output "migration_job_service_account" {
  description = "Existing service account used by the production governed Migration Job."
