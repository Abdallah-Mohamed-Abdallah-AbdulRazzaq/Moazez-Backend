...
describe('Applicant Portal request ownership (e2e)', () => {
  ...
  it('registers request and current document routes while keeping deferred actions absent', async () => {
  ...
  it('keeps required documents, document list, and missing download behavior guarded', async () => {
    await request(app.getHttpServer())
      .get(
