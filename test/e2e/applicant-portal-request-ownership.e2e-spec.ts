...
describe('Applicant Portal request ownership (e2e)', () => {
  ...
  it('registers draft request routes and keeps submit/document/upload routes absent', async () => {
  ...
  it('keeps required documents endpoint working and keeps submit/upload/document routes absent', async () => {
    await request(app.getHttpServer())
      .get(
