...
export const DASHBOARD_ANALYTICS_SOURCES_CATALOG: readonly DashboardAnalyticsSourceDefinition[] =
  [
    ...
    },
    {
      ...
      status: 'available',
      description:
        'Academic structure, allocation, timetable, and curriculum readiness analytics.',
    },
    {
      source: 'attendance',
      label: 'Attendance',
      status: 'available',
      description:
        'Attendance operational analytics and future trend definitions.',
    },
    {
      source: 'grades',
      label: 'Grades',
    ...
    },
    {
      ...
      status: 'available',
      description:
        'Homework assignment, submission review, and grade-sync analytics.',
    },
    {
      source: 'behavior',
      label: 'Behavior',
...
export const DASHBOARD_ANALYTICS_METRICS: readonly DashboardAnalyticsMetricDefinition[] =
  [
    metric(
      ...
      'admissions',
      'Open applications',
      'Admission applications still in an open operational state.',
      'count',
      null,
      'count',
      ['Application'],
    ...
    metric(
      ...
      'Admission applications submitted and waiting for school processing.',
      'count',
      null,
      'count',
      ['Application'],
    ...
    metric(
      ...
      'Admission applications with accepted decisions.',
      'count',
      null,
      'count',
    ...
    metric(
      ...
      'students',
      'Active students',
      'Currently active student records in the school.',
      'count',
      null,
      'count',
      ['Student'],
    ...
    metric(
      ...
      'students',
      'Active enrollments',
      'Current active student enrollments.',
      'count',
      null,
      'count',
      ['Enrollment'],
    ...
    metric(
      ...
      'attendance',
      "Today's pending attendance sessions",
      'Attendance sessions for today that still require submission.',
      'count',
      null,
      'count',
      ['AttendanceSession'],
    ...
    metric(
      ...
      'Attendance entries marked absent today.',
      'count',
      null,
      'count',
      ['AttendanceEntry'],
    ...
    metric(
      ...
      'Attendance entries marked late today.',
      'count',
      null,
      'count',
      ['AttendanceEntry'],
    ...
    metric(
      ...
      'Question-based grade submissions waiting for review.',
      'count',
      null,
      'count',
      ['GradeSubmission'],
    ...
    metric(
      ...
      'Grade submission answers waiting for review.',
      'count',
      null,
      'count',
    ...
    metric(
      ...
      'Homework submissions submitted and awaiting review.',
      'count',
      null,
      'count',
      ['HomeworkSubmission'],
    ...
    metric(
      ...
      'behavior',
      'Behavior records pending review',
      'Submitted behavior records waiting for review.',
      'count',
      null,
      'count',
      ['BehaviorRecord'],
    ...
    metric(
      ...
      'reinforcement',
      'Reinforcement reviews pending',
      'Reinforcement submissions waiting for approval or rejection.',
      'count',
      null,
      'count',
    ...
    metric(
      ...
      'Communication reports waiting for moderation.',
      'count',
      null,
      'count',
    ...
    metric(
      ...
      'settings',
      'Email connection active',
      'Whether the school email connection is active or verified.',
      'boolean',
      null,
      'snapshot',
    ...
    metric(
      ...
      'settings',
      'Login identity configured',
      'Whether school login identity settings are configured.',
      'boolean',
      null,
      'snapshot',
      ['SchoolLoginSettings'],
...
export const DASHBOARD_ANALYTICS_KPIS: readonly DashboardAnalyticsKpiDefinition[] =
  [
    kpi(
      ...
      'settings',
      'School operational health',
      'High-level operational health synthesized from dashboard readiness signals.',
      [
        'students.active_students',
        'attendance.pending_sessions_today',
        'settings.email_connection_active',
    ...
    kpi(
      ...
      'admissions',
      'Admissions pending work',
      'Admissions workload requiring school follow-up.',
      ['admissions.open_applications', 'admissions.submitted_applications'],
      'warning',
    ...
    kpi(
      ...
      'students',
      'Enrollment health',
      'Student and enrollment readiness indicator.',
      ['students.active_students', 'students.active_enrollments'],
      'info',
      '/students',
    ),
    kpi(
      ...
      'academics',
      'Academics readiness',
      'Academic structure, allocation, curriculum, and timetable readiness.',
      [],
      'warning',
      '/academics/overview',
    ),
    kpi(
      ...
      'attendance',
      "Today's attendance readiness",
      'Measures whether today attendance sessions are submitted.',
      ['attendance.pending_sessions_today'],
      'warning',
    ...
    kpi(
      ...
      'grades',
      'Grades review backlog',
      'Grade submissions and answers waiting for review.',
      ['grades.pending_submissions', 'grades.pending_answer_reviews'],
      'warning',
      '/grades/submissions',
    ),
    kpi(
      ...
      'homework',
      'Homework review backlog',
      'Homework submissions waiting for teacher review.',
      ['homework.submissions_waiting_review'],
      'warning',
    ...
    kpi(
      ...
      'behavior',
      'Behavior review backlog',
      'Behavior records waiting for review.',
      ['behavior.pending_review_records'],
      'warning',
      '/behavior/review',
    ),
    kpi(
      ...
      'reinforcement',
      'Reinforcement review backlog',
      'Reinforcement submissions waiting for approval.',
      ['reinforcement.pending_reviews'],
      'warning',
    ...
    kpi(
      ...
      'communication',
      'Communication safety queue',
      'Moderation workload in communication safety queues.',
      ['communication.pending_moderation_reports'],
      'critical',
    ...
    kpi(
      ...
      'Core operational settings readiness.',
      [
        'settings.email_connection_active',
        'settings.login_identity_configured',
      ],
...
export const DASHBOARD_ANALYTICS_CHARTS: readonly DashboardAnalyticsChartDefinition[] =
  [
    chart(
      ...
      'admissions',
      'Admissions funnel',
      'Applications moving through the admissions funnel.',
      'funnel',
      [
        series('lead', 'Leads'),
    ...
    chart(
      ...
      'Daily attendance counts by present, absent, and late status.',
      'line',
      [
    ...
    chart(
      ...
      'Attendance entry distribution by status.',
      'stacked-bar',
      [
        series('present', 'Present'),
        series('absent', 'Absent'),
    ...
    chart(
      ...
      'Attendance sessions waiting for submission.',
      'bar',
    ...
    chart(
      ...
      'attendance',
      'Excuse status',
      'Attendance excuse requests by review status.',
      'pie',
      [
    ...
    chart(
      ...
      'academics',
      'Structure readiness',
      'Academic structure setup readiness.',
      'radial-progress',
    ...
    chart(
      ...
      'Subject allocation coverage by academic scope.',
      'bar',
    ...
    chart(
      ...
      'Grade submissions waiting for review.',
      'bar',
    ...
    chart(
      ...
      'Homework assignments grouped by status.',
      'donut',
      [
        series('draft', 'Draft'),
        series('published', 'Published'),
    ...
    chart(
      ...
      'behavior',
      'Positive/negative behavior trend',
    ...
    chart(
      ...
      'reinforcement',
      'Task completion',
      'Reinforcement task completion status.',
      'bar',
      [
    ...
    chart(
      ...
      'Reward redemptions grouped by status.',
      'funnel',
      [
    ...
    chart(
      ...
      REVIEW_FILTERS,
      computedSnapshotOptions(
        'No pending communication moderation reports found for this school.',
      ),
    ),
    chart(
      'settings.email_connection_readiness',
      ...
      'School email connection readiness.',
      'radial-progress',
      [series('ready', 'Ready')],
      ['status'],
      computedSnapshotOptions(
        'School email connection readiness can be computed from current settings.',
      ),
    ),
    chart(
      'settings.login_identity_readiness',
      ...
      'School login identity readiness.',
      'radial-progress',
      [series('configured', 'Configured')],
      ['status'],
      computedSnapshotOptions(
        'School login identity readiness can be computed from current settings.',
      ),
    ),
    chart(
...
function chart(
  ...
  return {
    ...
    definitionEndpoint,
    dataEndpoint: `${definitionEndpoint}/data`,
    endpointPurpose: 'definition',
...
function series(
  key: string,
  label: string,
): DashboardAnalyticsSeriesDefinition {
  return { key, label };
}
