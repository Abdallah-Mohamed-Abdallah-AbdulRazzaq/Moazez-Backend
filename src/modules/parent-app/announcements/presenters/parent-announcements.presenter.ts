import {
  ParentAnnouncementAttachmentDto,
  ParentAnnouncementAttachmentsResponseDto,
  ParentAnnouncementCardDto,
...
import type {
  ...
  ParentAnnouncementReadResult,
  ParentAnnouncementsListReadModel,
} from '../infrastructure/parent-announcements-read.adapter';

export class ParentAnnouncementsPresenter {
  static presentList(
    result: ParentAnnouncementsListReadModel,
  ): ParentAnnouncementsListResponseDto {
    return {
  ...
  static presentAnnouncement(
    item: ParentAnnouncementReadModel,
  ): ParentAnnouncementResponseDto {
    return {
  ...
  static presentReadResult(
    result: ParentAnnouncementReadResult,
  ): ParentAnnouncementReadResponseDto {
    return {
  ...
  static presentAttachments(params: {
    ...
    attachments: ParentAnnouncementAttachmentRecord[];
  }): ParentAnnouncementAttachmentsResponseDto {
    return {
...
function presentAttachment(
  attachment: ParentAnnouncementAttachmentRecord,
): ParentAnnouncementAttachmentDto {
  return {
...
function senderName(
  announcement: ParentAnnouncementReadModel['announcement'],
): string | null {
