...
import { MarkAttendanceAbsenceExcusedDto } from '../dto/attendance-absences.dto';
import { assertAttendanceIncidentCanBeExcused } from '../domain/attendance-incident';
...
@Injectable()
export class MarkAttendanceAbsenceExcusedUseCase {
  constructor(
    private readonly attendanceAbsencesRepository: AttendanceAbsencesRepository,
    private readonly authRepository: AuthRepository,
  ) {}

  async execute(entryId: string, command: MarkAttendanceAbsenceExcusedDto) {
    ...
    assertAttendanceIncidentCanBeExcused(incident.status);
