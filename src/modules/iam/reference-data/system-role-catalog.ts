...
export const SYSTEM_ROLES: SystemRoleSeed[] = [
  {
    ...
    description:
      'Full platform-level access across all organizations and schools',
    permissions: ALL,
  },
  {
  ...
  },
  {
    ...
    name: 'Teacher',
    description:
      'Classroom-level access for attendance, grades, and reinforcement',
  ...
  },
  {
    ...
    name: 'Parent',
    description:
      'Read access to linked children and communication with the school',
  ...
  },
  {
    ...
    description:
      'School dismissal app access for assigned pickup and handover operations',
