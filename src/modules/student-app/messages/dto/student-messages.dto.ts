...
export const STUDENT_MESSAGE_CONTACT_ROLES = [
  'teacher',
  'student',
  'parent',
] as const;
...
export class ListStudentMessageContactsQueryDto {
  @IsOptional()
  @IsString()
  @MaxLength(80)
  q?: string;
  ...
  @IsOptional()
  @Transform(({ value }) => toLowerOptionalString(value))
  @IsIn(STUDENT_MESSAGE_CONTACT_ROLES)
  role?: string;
...
export class CreateStudentMessageConversationDto {
  @IsString()
  @MaxLength(128)
  contactId!: string;
}
...
export class StudentMessageContactDto {
  contactId!: string;
  contact_id!: string;
  displayName!: string;
  display_name!: string;
...
export class StudentMessageContactsResponseDto {
  contacts!: StudentMessageContactDto[];
