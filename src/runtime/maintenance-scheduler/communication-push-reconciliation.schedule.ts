...
@Injectable()
export class CommunicationPushReconciliationSchedule implements OnModuleInit {
  ...
  async onModuleInit(): Promise<void> {
    ...
    this.logger.log({
      ...
      queue: COMMUNICATION_NOTIFICATION_PUSH_QUEUE_NAME,
      job: COMMUNICATION_NOTIFICATION_PUSH_RECONCILE_JOB_NAME,
    });
  }
}
