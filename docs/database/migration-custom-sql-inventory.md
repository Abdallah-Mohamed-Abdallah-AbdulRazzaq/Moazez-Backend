...
| ----------------------------------------------------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `20260416225721_0001_core_identity`                         | `memberships_ended_at_required_when_inactive_check`       | A non-active membership must have `ended_at`: `status = 'ACTIVE' OR ended_at IS NOT NULL`.                                         | Auth/tenancy fixtures exercise valid states, but no direct invalid-row database assertion exists. Catalog verification and fresh replay cover preservation.   |
