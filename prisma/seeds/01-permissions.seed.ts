...
const PERMISSIONS: PermissionSeed[] = [
  ...
  // homework
  { code: 'homework.assignments.view', module: 'homework', resource: 'assignments', action: 'view', description: 'View core homework assignments' },
  ...
  { code: 'communication.admin.manage', module: 'communication', resource: 'admin', action: 'manage', description: 'Manage communication administration controls' },
